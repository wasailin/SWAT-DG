...
class FigFileParser:
    ...
    def get_reach_for_subbasin(self, subbasin_id: int) -> Optional[int]:
        ...
        For example, subbasin 10 may feed reach 15, while
        reach 10 receives water from a different subbasin.
    ...
    def get_upstream_subbasins_by_subbasin(self, subbasin_id: int) -> Set[int]:
        ...
        For example, if subbasin 10 maps to reach 15:
            - get_upstream_subbasins(10) returns subs routed through reach 10
            - get_upstream_subbasins_by_subbasin(10) returns all subs draining
              through subbasin 10's outlet (using the sub→reach translation)
    ...
    def has_accumulated_routing(self) -> bool:
        ...
        In some SWAT models, every route command takes only
