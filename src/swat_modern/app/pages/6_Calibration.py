...
def _wq_observation_ui(
    ...
    if _wq_file is not None:
        ...
        _wq_fmt = st.selectbox(
            "WQ file format",
            ["auto", "adeq", "obsfiles", "awrc", "generic"],
        ...
        try:
            ...
            if _wq_df is not None and not _wq_df.empty:
                ...
                _avail = []
                for _c, _l in [("TN_mg_L", "TN"), ("TP_mg_L", "TP"), ("TSS_mg_L", "TSS")]:
                ...
                st.success(
                    ...
                    + (f" | Available: {', '.join(_avail)}" if _avail else "")
                )
                if _n_vals == 0:
                    st.warning(
